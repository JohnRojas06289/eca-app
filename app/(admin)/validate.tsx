...
const INITIAL_WEIGHINGS: PendingWeighing[] = [
  { id: '1', recyclerName: 'Juan Pérez',   material: 'Plástico PET',     materialType: 'plastic',   kg: 12.5, pricePerKg: 800,  date: new Date(now.getTime() - 95 * 60 * 1000), route: 'Centro Histórico'  },
  { id: '2', recyclerName: 'Juan Pérez',   material: 'Cartón Corrugado', materialType: 'cardboard', kg: 45.0, pricePerKg: 350,  date: new Date(now.getTime() - 2.4 * 60 * 60 * 1000), route: 'Centro Histórico', note: 'Cartón húmedo, se descontó 3 kg'  },
  { id: '3', recyclerName: 'Carlos Romero',material: 'Aluminio',         materialType: 'metals',    kg: 3.4,  pricePerKg: 2200, date: new Date(now.getTime() - 20 * 60 * 60 * 1000), route: 'San Pablo Norte'   },
];

export default function ValidateWeighingsScreen() {
  ...
  async function handleApprove(id: string) {
    ...
    try {
      ...
      // await WeighingApi.validate({ id, action: 'approve' });
  ...
  function confirmReject(id: string, recyclerName: string) {
    Alert.alert(
      'Rechazar pesaje',
      `¿Rechazar el pesaje de ${recyclerName}? Esta acción no se puede deshacer.`,
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            setProcessing(id);
            try {
              // ⚠️ await WeighingApi.validate({ id, action: 'reject' });
    ...
    return (
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Validar Pesajes</Text>
          <View style={{ width: 24 }} />
        </View>
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyBody}>No hay pesajes pendientes de validación.</Text>
          <CustomButton
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.infoBanner}>
        ...
        <Text style={styles.infoBannerText}>
          Revisa cada pesaje antes de aprobar. Los rechazados no se pagarán al reciclador.
        </Text>
      </View>
            ...
            <View key={w.id} style={styles.weighingCard}>
              ...
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardHeaderInfo}>
                  ...
                  <Text style={styles.recyclerName}>{w.recyclerName}</Text>
                </View>
              ...
              <View style={styles.cardActions}>
                <TouchableOpacity
                  ...
                  onPress={() => confirmReject(w.id, w.recyclerName)}
                  disabled={isLoading}
                  activeOpacity={0.8}
                >
