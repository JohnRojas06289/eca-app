...
const INITIAL_WEIGHINGS: PendingWeighing[] = [
  { id: '1', recyclerName: 'Juan Pérez',   material: 'Plástico PET',     materialType: 'plastic',   kg: 12.5, pricePerKg: 800,  timestamp: 'Hoy, 10:30 AM',  route: 'Centro Histórico'  },
  { id: '2', recyclerName: 'Juan Pérez',   material: 'Cartón Corrugado', materialType: 'cardboard', kg: 45.0, pricePerKg: 350,  timestamp: 'Hoy, 09:15 AM',  route: 'Centro Histórico', note: 'Cartón húmedo, se descontó 3 kg'  },
  { id: '3', recyclerName: 'Carlos Romero',material: 'Aluminio',         materialType: 'metals',    kg: 3.4,  pricePerKg: 2200, timestamp: 'Ayer, 4:30 PM',  route: 'San Pablo Norte'   },
];
